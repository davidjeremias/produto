...
import com.u2d.produto.exception.StringException;
...
public class StringUtil {
	...
	//----------------------------------------------
	public static String mascaraTelefone(String telefone) throws StringException {
		String novoTelefone = null;
		if(telefone != null && !telefone.isEmpty()){
			if(telefone.length() < 10 || telefone.length() > 11) {
				throw new StringException("Número de telefone com quantidade de caracteres inválido ex.: tel fix 99 9999 9999 tel mov 99 99999 9999");
			}
